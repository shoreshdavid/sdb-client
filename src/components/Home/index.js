...
export const Home = props => {
  return (
    <div className='container-fluid'>
      <div>
        <iframe width="1040" height="618" src="https://www.youtube.com/embed/djrY_eFDOwE?list=RDfff1c-HZf50" frameBorder="0" allowFullScreen></iframe>
      </div>
