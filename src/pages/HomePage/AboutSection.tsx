  ...
  return (
    <Container fluid id="aboutSection" className="about-container">
      ...
      <p className="secondary-text" style={{ textAlign: 'justify' }}>
        ...
        their Messiah. Therefore, we reach out internationally with our healing
        teachings and more to positively change their lives. For He said: “I am
        ...
        </a>&nbsp;to see how and why to accept Yeshua today.
      </p>
    </Container>
  );
};
