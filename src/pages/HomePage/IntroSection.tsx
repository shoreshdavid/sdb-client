        ...
        <Col lg={{ size: 8, offset: 2 }}>
          <div style={{ textAlign: 'center', marginBottom: 80 }}>
            <img
              ...
              className="img-fluid"
            />
            <hr className="brand-hr" style={{ width: 140 }} />
            <Link to="/">445 Lithia Pinecrest Rd. Brandon, FL 33511</Link>
      ...
      <Row>
        <Col lg="7">
          ...
          <p>
            ...
            Gentiles who are genuinely warm, loving, friendly and caring. Ours
