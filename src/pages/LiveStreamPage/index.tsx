    ...
    <div className="container-fluid padding-100">
      <div className="row">
        <div className="live-meta">
          ...
          <p>If that doesn't help or you are on a mobile device, try going to our YouTube channel (and Subscribe so you get notifications) at https://www.youtube.com/watch?v=uoWrAP7gsIk</p>
        </div>
      </div>
      <div className="row">
        <div className="col-lg-8">
          <iframe
            src="https://www.youtube.com/embed/uoWrAP7gsIk"
            frameBorder="0"
            scrolling="no"
            allowFullScreen
