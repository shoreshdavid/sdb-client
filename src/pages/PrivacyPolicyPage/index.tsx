  ...
  <React.Fragment>
    ...
    <div className="container-fluid" style={{ padding: 25 }}>
      ...
      <p>
        ...
        Privacy applies to shoreshdavidbrandon.org and Shoresh David Messianic
        Synagogue of Brandon Inc. and governs data collection and usage. For the
        purposes of this Privacy Policy, unless otherwise noted, all references
        to Shoresh David Messianic Synagogue of Brandon Inc. include
        shoreshdavidbrandon.org and Shoresh David Brandon. The Shoresh David
        Brandon website is a synagogue website site. By using the Shoresh David
        Brandon website, you consent to the data practices described in this
        statement.
      </p>
      ...
      <p>
        ...
        Shoresh David Brandon may also use your personally identifiable
        information to inform you of other products or services available from
        Shoresh David Brandon and its affiliates.
      </p>
      <h3>Sharing Information with Third Parties</h3>
      <p>
        Shoresh David Brandon does not sell, rent or lease its customer lists to
        third parties. Shoresh David Brandon may, from time to time, contact you
        ...
        not transferred to the third party. Shoresh David Brandon may share data
        ...
        personal information except to provide these services to Shoresh David
        Brandon, and they are required to maintain the confidentiality of your
        information.
      </p>
      <p>
        Shoresh David Brandon may disclose your personal information, without
        ...
        comply with legal process served on Shoresh David Brandon or the site;
        (b) protect and defend the rights or property of Shoresh David Brandon;
        and/or (c) act under exigent circumstances to protect the personal
        safety of users of Shoresh David Brandon, or the public.
      </p>
      <h3>Automatically Collected Information</h3>
      <p>
        Information about your computer hardware and software may be
        automatically collected by Shoresh David Brandon. This information can
        include: your IP address, browser type, domain names, access times and
        referring website addresses. This information is used for the operation
        of the service, to maintain quality of the service, and to provide
        general statistics regarding use of the Shoresh David Brandon website.
      </p>
      <h3>Links</h3>
      <p>
      ...
      <p>
        Shoresh David Brandon secures your personal information from
        unauthorized access, use, or disclosure. Shoresh David Brandon uses the
      ...
      <p>
        ...
        as the Secure Sockets Layer (SSL) protocol. We strive to take
        appropriate security measures to protect against unauthorized access to
        or alteration of your personal information. Unfortunately, no data
      ...
      <p>
        Shoresh David Brandon does not knowingly collect personally identifiable
      ...
      <p>
        Shoresh David Brandon reserves the right to change this Privacy Policy
        ...
        of the modified Privacy Policy; and (b) agreement to abide and be bound
        by that Policy.
      </p>
      <h3>Contact Information</h3>
      <p>
        Shoresh David Brandon welcomes your questions or comments regarding this
        Statement of Privacy. If you believe that Shoresh David Brandon has not
        adhered to this Statement, please contact Shoresh David Brandon at:
        Shoresh David Messianic Synagogue of Brandon Inc. 445 Lithis Pinecrest
